namespace apelanterns.ModSystem
{
    ...
    public class BlockFloatingLantern : Block, IDrawYAdjustable //1.20
    {
        ...
        public override void OnNeighbourBlockChange(IWorldAccessor world, BlockPos pos, BlockPos neibpos)
        {
            ...
            if (world.BlockAccessor.GetBlockEntity(neibpos) is BEFloatingLantern bebBlock) //now do the new block
            {
                var updated = false;
                if (thisBlock.FirstCodePart() == neibBlock.FirstCodePart()) //added a neighbor
                {
        ...
        public override string GetPlacedBlockInfo(IWorldAccessor world, BlockPos pos, IPlayer forPlayer)
        {
            ...
            */
            ...
            {
                dsc.AppendLine("\n<font color=\"#D8EAA3\"><i>" + Lang.GetMatching("game:tabname-apelanterns") + "</i></font>").AppendLine();
            }
            return dsc.ToString();
